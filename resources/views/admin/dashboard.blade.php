                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{asset('asset/assets/img/logoproduct.svg')}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{asset('backend/assets/img/logoproduct2.svg')}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
